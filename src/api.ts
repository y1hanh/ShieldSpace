...
function fetchWithSecureToken(path: string, method: Methond = 'GET', options: RequestInit = {}) {
  const params: RequestInit = {
    ...
    headers: {
      ...
      Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRhMzAiLCJwYXNzd29yZCI6ImZpdDUxMjB0YTMwIiwiaWF0IjoxNzQ1OTcxNDMyLCJleHAiOjE3NDYwMDc0MzJ9.TXDU6ThgXEUGFVO6BzVwVsABUqReR8SkeEFiQ7Vyaxk`,
